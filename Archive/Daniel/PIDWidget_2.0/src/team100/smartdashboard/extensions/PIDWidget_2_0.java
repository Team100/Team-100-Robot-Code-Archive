...
public class PIDWidget_2_0 extends StaticWidget {
    ...
    public PIDWidget_2_0() {

        thready = new paintingThread();
        bufferSize = new IntegerProperty(this, "Buffer Size (samples)", 2000);
        tablePath = new StringProperty(this, "Table Path", "PIDSystems/FrontShooterPID");
    ...
    public void init() {
        ...
        System.out.println("kP" + table.getNumber("kP"));
        pField.setText("" + table.getNumber("kP"));
        iField.setText("" + table.getNumber("kI"));
        dField.setText("" + table.getNumber("kD"));
        maxVelocityField.setText("" + table.getNumber("kMaxVeloc"));
        maxOutputField.setText("" + table.getNumber("kMaxOutput"));
        minOutputField.setText("" + table.getNumber("kMinOutput"));
        revalidate();
        repaint();
