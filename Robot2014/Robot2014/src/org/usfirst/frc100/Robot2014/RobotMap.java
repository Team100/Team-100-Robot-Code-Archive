...
public class RobotMap {
    ...
    public static Relay shooterRelease;
    public static Encoder shooterEncoder;
    public static SpeedController intakeTopMotor;
    public static SpeedController intakeBottomMotor;
    public static Relay intakeTopPiston;
    public static Relay intakeBottomPiston;
    ...
    public static void init() {
        ...
        intakeTopPiston = new Relay(1, 1);
        LiveWindow.addActuator("Intake", "TopPiston", intakeTopPiston);

        intakeBottomPiston = new Relay(1, 2);
