...
public class Preferences {
    ...
    // Tilter PID
    public static double tilterPotToDegreeRatio = .256; // pot / ratio = degrees
    public static double tilterPotOffsetDegrees = 0; // degrees + offset = angle
    public static double tilterAngleBuffer = 1; // degrees tilter can be off by
    public static double tilter_kP = 0.0; // error * kP = motor speed
    // Tilter angles (in degrees)
    public static double shootHighAngle = 0;
    public static double shootLowAngle = 0;
