...
public class Preferences {
    ...
    public static double tilterPotToDegreeRatio = 3.6556; // (change in "TilterSensorValue")/(change in actual angle in degrees)
    public static double tilterPot180DegreePosition = 535.0; // "TilterSensorValue" when tilter is straight up (180 degrees)
    ...
    public static double shooterPotToInchRatio = 32.276; // (change in "ShooterSensorValue")/(change in actual distance pulled back in inches)
