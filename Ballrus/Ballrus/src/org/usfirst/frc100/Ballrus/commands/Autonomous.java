    ...
    public Autonomous() {
        ...
        switch (mode) {
            case 1: //drive and shoot
                ...
                addSequential(new AutoDriveStraight(24.0));//drive to wall
                break;
            case 2: //shoot and drive
                ...
                addParallel(new TriggerShootReload());
                addSequential(new Pause(1.0));//wait for shot
                addSequential(new AutoDriveStraight(24.0));
                break;
            ...
            case 4: //Vision
                addParallel(new TiltToShootHigh());
                addParallel(new ArmShooter());
                addSequential(new AutoDriveStraight(24.0));//drive to close shooting position
