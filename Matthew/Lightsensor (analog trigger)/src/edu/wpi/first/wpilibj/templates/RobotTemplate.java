...
public class RobotTemplate extends IterativeRobot {
    ...
    public void teleopInit()   {
        ...
        /*this section does not reset the very first time (the count will start in the 30s)
         but it will reset to zero if disabled and enabled again.*/
    }
    /**
    ...
    SmartDashboard.putInt("Count is", counter.get());

    lightsensor.setLimitsVoltage(1.0, 2.8);
    /* Approx. light voltage for white binder paper: 0.2 Aprrox. for dark marker line on the paper: 3.7. */
