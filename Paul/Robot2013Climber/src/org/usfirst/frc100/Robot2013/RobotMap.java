...
public class RobotMap {
    ...
    public static final Encoder climberEncoder = new Encoder(1,2);
    public static final DigitalInput climberTopSwitch = new DigitalInput(3);
    public static final DigitalInput climberBottomSwitch = new DigitalInput(4);
    ...
    public static final Victor climberBottomMotor = new Victor(2);
