...
public class Climber extends Subsystem {
    ...
    double elevatorSpeed=.2;//speed that elevator will move
    ...
    private int lowerElevatorPartwayLimit=1000;//how far the robot has to pull itself up the third time
    ...
    public void putData(){
        ...
        SmartDashboard.putNumber("Motor", climberMotor.get());
    }
