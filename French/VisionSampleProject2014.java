...
public class VisionSampleProject2014 extends SimpleRobot {
    // Dummy comment for source control -part 2
    ...
    final double VIEW_ANGLE = 44;		// Measured for M1011  rff  was 49
    ...
    public void robotInit() {
        camera = AxisCamera.getInstance("10.1.0.12");  // get an instance of the camera
	...
	int verticalTargetCount, horizontalTargetCount;
         ...
         while (isAutonomous() && isEnabled()) {
            try {
                System.out.println("Got into Vision Code");
                /**
                ...
                //image = new RGBImage("/image3_0208.jpg");
                //image = new RGBImage("/Center18ft_On2.jpg");
                // System.out.println("Finished opening image");
                ...
                // thresholdImage.write("/image_binary.bmp");  // rff check output of threshold operation
        ...
        // executionTimer.stop();
        // System.out.println("Execution Time = " + executionTimer.get());
        }  //end of while loop
    }
