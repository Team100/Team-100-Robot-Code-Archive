...
public class RobotMap {
    ...
    public static DoubleSolenoid climberClimberPiston;
    public static SpeedController shooterShooterMotor;
    public static DigitalInput shooterShooterEncoder1;
    public static Encoder shooterShooterEncoder2;
	...
	LiveWindow.addSensor("Climber", "ClimberAnglePot", climberClimberAnglePot);
        ...
        climberClimberPiston = new DoubleSolenoid(1, 5, 6);      
	
        
        shooterShooterMotor = new Talon(1, 6);
	LiveWindow.addActuator("Shooter", "ShooterMotor", (Talon) shooterShooterMotor);
        
        shooterShooterEncoder1 = new DigitalInput(1, 7);
	LiveWindow.addSensor("Shooter", "ShooterEncoder 1", shooterShooterEncoder1);
        
        shooterShooterEncoder2 = new Encoder(1, 8, 1, 11, false, EncodingType.k4X);
	LiveWindow.addSensor("Shooter", "ShooterEncoder 2", shooterShooterEncoder2);
        shooterShooterEncoder2.setDistancePerPulse(1.0);
        shooterShooterEncoder2.setPIDSourceParameter(PIDSourceParameter.kRate);
        shooterShooterEncoder2.start();
