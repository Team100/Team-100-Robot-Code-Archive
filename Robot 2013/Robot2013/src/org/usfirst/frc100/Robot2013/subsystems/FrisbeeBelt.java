 ...
 *
 */
public class FrisbeeBelt extends Subsystem {
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    SpeedController beltMotor = RobotMap.frisbeeBeltBeltMotor;
    DigitalInput bottomLimitSwitch = RobotMap.frisbeeBeltBottomLimitSwitch;
